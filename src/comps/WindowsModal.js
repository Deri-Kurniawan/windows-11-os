...
const WindowsModal = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className={`${winModalToggled === true ? "absolute" : "hidden"} top-[2vh] w-full h-[87vh] lg:top-[5vh] lg:left-[30vw] lg:w-[40vw] lg:h-[87vh] text-white bg-gray-900 rounded-md border-gray-500 border-[1px]`}>
